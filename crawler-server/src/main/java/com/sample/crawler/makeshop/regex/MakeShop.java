package com.sample.crawler.makeshop.regex;
...
public class MakeShop {
  ...
  public static final String MAKE_SHOP_PAGE_REGEX = "/shop/shopbrand.html\\?type=([A-Z])&xcode=([0-9]{3})(&mcode=([0-9]{3})&sort=|&sort=)&page=([0-9]{0,3})";
